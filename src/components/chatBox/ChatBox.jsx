...
const ChatBox = () => {
  ...
  return chatUser ? (
    <div className={`chat-box ${chatVisible ? '' : "hidden"}`}>
      ...
      <div className="chat-input">
        <input onChange={(e) => setInput(e.target.value)} value={input} type="text" placeholder='Type message' />
  ...
  <div className={`chat-welcome ${chatVisible ? '' : "hidden"}`}>
    ...
    <p>Make Sm<span>a</span>llT<span>a</span>lk with anyone, anywhere</p>
  </div>
}
